...
public class AutocorrelationErrorDialog extends DefaultDialog {
	...
	private static final AppProperty defaultWeightMethodProperty =
			AppProperty.WEIGHT_ERROR_DEFAULT_WEIGHT_METHOD;
	private static final AppProperty defaultBlocksProperty =
			AppProperty.BLOCKS_DEFAULT;

	private AppGlobals appGlobals;

	public AutocorrelationErrorDialog(AppGlobals appGlobals){
		...
		this.setTitle("Set autocorrelation error parameters");
		this.pack();
	}
	...
	protected void confirm() {
		...
		LinePlotType plotType = LinePlotType.AUTOCORRELATION;
