...
public class DeactivateTimepointWeightingTest extends AbstractIntegrationTestTask {
	
	public DeactivateTimepointWeightingTest(Bundle bundle, AppGlobals appGlobals){
	...
	protected void runTest(TaskMonitor taskMonitor) {
		...
		tasks.append(new ActivateAverageFrameWeightingTaskFactory(appGlobals, FrameWeightMethod.OCCURRENCE)
				.createTaskIterator());
