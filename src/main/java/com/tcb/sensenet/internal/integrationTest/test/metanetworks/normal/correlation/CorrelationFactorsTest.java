...
public class CorrelationFactorsTest extends AbstractIntegrationTestTask {

		
	public CorrelationFactorsTest(Bundle bundle, AppGlobals appGlobals){
	...
	protected void runTest(TaskMonitor taskMonitor) throws IOException {
		...
		CorrelationFactorsTaskConfig config = CorrelationFactorsTaskConfig.create(
				EdgeCorrelationMethod.MUTUAL_INFORMATION,
	...
	public TestReference getReference() {
		return TestReference.CORRELATION_FACTOR;
	}		
}
