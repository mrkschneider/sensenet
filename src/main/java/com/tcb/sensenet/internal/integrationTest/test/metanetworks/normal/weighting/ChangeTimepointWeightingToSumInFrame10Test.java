...
public class ChangeTimepointWeightingToSumInFrame10Test extends AbstractIntegrationTestTask {
	
	private static final int frame = 10;

	public ChangeTimepointWeightingToSumInFrame10Test(Bundle bundle, AppGlobals appGlobals){
	...
	protected void runTest(TaskMonitor taskMonitor) {
		...
		tasks.append(new ActivateSingleFrameWeightingTaskFactory(appGlobals, FrameWeightMethod.SUM, frame)
				.createTaskIterator());
	...
	public TestReference getReference() {
		return TestReference.SUM_WEIGHTED_TIMEPOINT_FRAME10;
	}		
}
