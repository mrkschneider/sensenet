...
public class AutocorrelationErrorWithSumWeightingTest extends AbstractIntegrationTestTask {
	
	public AutocorrelationErrorWithSumWeightingTest(Bundle bundle, AppGlobals appGlobals){
	...
	protected void runTest(TaskMonitor taskMonitor) {
		...
		FrameWeightMethod method = FrameWeightMethod.SUM;
		...
		tasks.append(new MetaTimelineAggregationTaskFactory(
				appGlobals)
	...
	public TestReference getReference() {
		return TestReference.AUTOCORRELATION_ERROR_SUM_WEIGHTING;
	}		
}
