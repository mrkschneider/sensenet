...
public class MaxAutocorrelationTimeMergeStrategyTest {

	private List<AutocorrelationAnalysisAdapter> analyses;
	private MaxAutocorrelationTimeWeightStrategy strategy;
	...
	public void setUp() throws Exception {
		this.analyses = Arrays.asList(
				...
				createAnalysis(200.),
				createAnalysis(50.));
		this.strategy = new MaxAutocorrelationTimeWeightStrategy();
	}
	...
	public void testMerge() {
		assertEquals(200.0,strategy.merge(analyses),0.01);
	}
