...
public class AverageAutocorrelationTimeMergeStrategyTest {

	private List<AutocorrelationAnalysisAdapter> analyses;
	private AverageAutocorrelationTimeWeightStrategy strategy;
	...
	public void setUp() throws Exception {
		this.analyses = Arrays.asList(
				...
				createAnalysis(200.),
				createAnalysis(50.));
		this.strategy = new AverageAutocorrelationTimeWeightStrategy();
	}
	...
	public void testMerge() {
		assertEquals(100.0,strategy.merge(analyses),0.01);
	}
